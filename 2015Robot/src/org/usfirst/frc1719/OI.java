...
public class OI {
    ...
    public static final int TRANSFER_CAMERA_CONTROL_BUTTON_ID = 1;
    ...
    public OI() {
        ...
        (new JoystickButton(joystick1, TRANSFER_CAMERA_CONTROL_BUTTON_ID))
        	.whenPressed(new TransferCameraControl(TransferCameraControl.DRIVER));
        (new JoystickButton(joystick2, TRANSFER_CAMERA_CONTROL_BUTTON_ID))
